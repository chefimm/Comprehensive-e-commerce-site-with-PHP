<?php require 'views/YonPanel/header.php'; ?>
	  ...
	  ?>
       ...
       <div class="row text-left border-bottom-mvc mb-2">  
        	 ...
        	 <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2 baslikana"><h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-th basliktext"></i> ÜYE GÜNCELLE </h1></div>
     <?php $PanelHarici->İcnavigasyon("uyeler","Üyeler","Üye Güncelle"); ?>            
       ...
       <div class="row text-center">  
        	 ...
        	 <div class="col-xl-4 col-md-6 mx-auto">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 formeleman">
					 ...
					 "action" => URL."/panel/uyeguncelle/son",
					 "method" => "POST"				
					 ));  
...
Form::OlusturOption(array("value"=>"1"),$veri["Uyeguncelle"][0]["durum"]==1 ? "selected" : false,"Aktif");
			 ...
			 Form::OlusturSelect("1",array("name"=>"grup","class"=>"form-control"));
			 
		
			foreach ($veri["smsgruplar"] as $deger):
	
Form::OlusturOption(array("value"=>$deger["id"]),$veri["Uyeguncelle"][0]["grupid"]==$deger["id"] ? "selected" : false,$deger["ad"]);						
	  ...
	  ?>
       ...
       <div class="row text-left border-bottom-mvc mb-2">  
        	 ...
        	 <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2 baslikana"><h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-th basliktext"></i> ÜYE ADRESLERİ </h1></div>
   <?php $PanelHarici->İcnavigasyon("uyeler","Üyeler","Üye Adresleri"); ?>         
       ...
       <div class="row text-center">  
        	 ...
        	 <div class="col-xl-4 col-md-6 mx-auto">
             		...
             		<div class="col-lg-12 col-md-12 col-sm-12 bg-gradient-mvc pt-2 basliktext2"><h3>Üye Adresleri</h3></div>
...
echo  $deger["varsayilan"]==1 ? "<br><span class='text-danger'>(Varsayilan)</span>" : "";
	 ...
	 // ÜYELER TÜMÜNÜN GÖRÜNDÜĞÜ YER
      ...
      <!-- BAŞLIK -->
       ...
       <div class="row text-left border-bottom-mvc mb-2">  
        	 ...
        	 <div class="col-lg-2 col-xl-2 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2 baslikana"><h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-th basliktext"></i> ÜYELER </h1></div>
              
 
    <div class="col-lg-3 col-xl-3 col-md-12 mb-12 p-2"><h1 class="h3 mb-0 text-gray-800">Toplam Üye : <?php echo $veri["toplamveri"]; ?></h1></div>  
...
<div class="col-lg-2 col-xl-2 col-md-12 col-sm-12 text-dark kalinyap p-2"> '.$value["grupad"].'</div>
...
<div class="col-xl-1 col-lg-1 col-md-12 col-sm-12 text-dark kalinyap p-2">'.$value["telefon"].'</div> 
...
<a href="'.URL.'/panel/uyeadresbak/'.$value["id"].'"  class="fas fa-address-book adresbuton mr-3 mt-1" ></a>

<a href="'.URL.'/panel/uyeGuncelle/ilk/'.$value["id"].'" class="fas fa-edit mt-1 guncelbuton"></a>

</div>
				   
				<div class="col-xl-1 col-lg-1 col-md-12 col-sm-12 text-dark kalinyap p-2 text-left">               
 <a href="'.URL.'/panel/uyeSil/'.$value["id"].'" class="fas fa-trash-alt silbuton mt-1"></a>  </div>
 </div> 
         ...
         <?php
		 if (isset($veri["arama"])) :
		 $link="/panel/uyearama/".$veri["arama"]."/";
