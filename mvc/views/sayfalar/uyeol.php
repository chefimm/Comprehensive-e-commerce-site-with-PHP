 ...
 <div class="registration-form">
	...
	<div class="dreamcrub">
	   ...
	   ?>
			...
			<div class="reg-form">
				<div class="reg">
					 <p>Üye olarak avantajlardan yararlanabilirsiniz.
                     </p>
...
<?php Form::Olustur("2",array("type"=>"text","name"=>"ad","required"=>"required")); ?>
				 ...
				 <li>     
<?php Form::Olustur("2",array("type"=>"text","name"=>"soyad","required"=>"required")); ?></li>
				 </ul>
                 				 
				 <ul>
				 <li class="text-info"><span class="text-danger">*</span> Mail Adresi: </li>
				 <li>
<?php Form::Olustur("2",array("type"=>"text","name"=>"mail","required"=>"required")); ?></li>
				 </ul>
                 
				 <ul>
				 <li class="text-info"><span class="text-danger">*</span> Sifre: </li>
				 <li> 
<?php Form::Olustur("2",array("type"=>"password","name"=>"sifre","required"=>"required")); ?></li>
				</ul>
						
                 <ul>
				 <li class="text-info"><span class="text-danger">*</span> Sifre Tekrar:</li>
				<li>
<?php Form::Olustur("2",array("type"=>"password","name"=>"sifretekrar","required"=>"required")); ?></li>
			    </ul>
						 <ul>
 ...
 Form::Olustur("2",array("type"=>"text","name"=>"telefon","required"=>"required")); ?></li>  	
                             ...
                             <ul>
							 <li class="text-info"><span class="text-danger">*</span> Güvenlik Kodu  <img src="<?php echo $veri["captcha"]; ?>"  id="capt" /> 
                             <a onclick=reloadEt(); class="glyphicon glyphicon-refresh" id="reload"></a> </li>
							 <li> <?php
 Form::Olustur("2",array("type"=>"text","name"=>"guvenlik","required"=>"required")); ?></li>  	
						 </ul>		
