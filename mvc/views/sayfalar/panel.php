...
?>
	...
	<div class="container" id="UyeCont">
    	...
    	<div class="row">
		   ...
		   <li><a href="<?php echo URL; ?>/uye/favoriler">Favori Ürünlerim</a></li>
		...
		foreach ($veri as $key => $deger) :		
				...
				case "yorumlar":				
				$Harici->UyeyorumGetir($veri["yorumlar"],$veri["toplamsayfa"],$veri["toplamveri"]);
				break;				
				...
				case "adresekle":
				if (isset($veri["bilgi"])) : echo $veri["bilgi"]; endif;							
				...
				case "favoriler":		
				$Harici->UyeFavoriGetir($veri["favoriler"]);
				break;					
