<?php require 'views/header.php'; ?>
 ...
 echo '<li><a href="'.URL.'/urunler/detay/'.$value["id"].'/'. $Harici->seo($value["ad"]).'">'.$value["ad"].'</a></li>';
	...
	<img src="'.URL.'/views/design/images/'.$value["res1"].'" class="img-responsive" alt="'.$value["urunad"].'"/>
      ...
      <?php 			   
		 if (isset($veri["katid"]) && isset($veri["katad"])) :
		 $link="/urunler/kategori/".$veri["katid"]."/".$veri["katad"]."/";		 
		 endif;	         
	   ...
	   ?> 
				   ...
				   <div class="row">
				  <div class="col-md-12 font-weigth-bold text-left">
                
                
   <?php 	echo "<b>Toplam ürün adeti : " .$veri["toplamveri"]."</b>";   ?> 
		...
		<div class="container">
			<h3 class="like text-center">ÖNE ÇIKAN ÜRÜNLER</h3>        			
			   ...
			   foreach ($veri["data3"] as $value) :
					...
					echo'	<li><a href="'.URL.'/urunler/detay/'.$value["id"].'/'. $Harici->seo($value["urunad"]).'"><img src="'.URL.'/views/design/images/'.$value["res1"].'" alt="'.$value["urunad"].'" class="img-responsive"/></a>
